                            ...
                            <div className="panel panel-primary">
                                ...
                                <div className="panel-footer clearfix">
                                    ...
                                    <div className="pull-right">
                                        <TxButton section="developer" className="btn btn-primary" vde={this.props.vde} contractName="@1Import" contractParams={{ Data: JSON.stringify(this.props.payload) }} disabled={this.isPristine()}>
